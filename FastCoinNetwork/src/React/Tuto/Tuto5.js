  ...
  render() {
    return (
        <div class="defil text-center mt-5">
            <h6 class="mt-1 mb-3">Comment créditer votre compte pour envoyer de l'argent:</h6>
            <li>Dans la plateforme Metamask, connectez-vous au réseau Ropsten</li>
            <li>Faites un dépôt du montant de votre choix vers l'adresse: 0x1cB750245A3931A80552DAEDEDf5A32B14ad6E21</li>
            ...
            <p class="mt-2">Votre compte est crédité!</p>
